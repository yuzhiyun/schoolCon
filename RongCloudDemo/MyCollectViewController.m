...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if(self) {
        ...
        self.titles = [NSArray arrayWithObjects:@"在线学习", @"心理知识",nil];
...
- (UIViewController *)pageController:(WMPageController *)pageController viewControllerAtIndex:(NSInteger)index {
    ...
    ArticleTableViewController *controller = [storyboard instantiateViewControllerWithIdentifier:@"ArticleTableViewController"];
